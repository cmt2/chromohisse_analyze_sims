...
chromohisse_output_fn <- mixedsort(list.files("output", pattern = "chromohisse", full.names = TRUE))
...
pdf("figures/chromohisse_boxplots_high_mu.pdf", height = 14, width = 10)
...
boxplot.HPD(chromohisse_results[,"turnover"], outline = FALSE, xaxt = "n", yaxt = "n", ylim = c(0.5,1.25))
...
pdf("figures/chromohisse_boxplots_high_mu_relative.pdf", height = 14, width = 10)
...
# get output filenames
chromosse_output_fn <- mixedsort(list.files("output", pattern = "chromosse", full.names = TRUE))
...
pdf("figures/chromosse_boxplots_high_mu.pdf", height = 14, width = 10)
